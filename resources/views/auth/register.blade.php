	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to Bitslat</h3>
                                    <p>An Ecommerce company in nigeria for providing goods to all.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                            <input required name="name" type="text" class="form-control" placeholder="Name" value="{{ old('name') }}" id="exampleInputEmail12">
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            <input required name="email" type="email" class="form-control" placeholder="Email" value="{{ old('email') }}" id="exampleInputEmail12">
