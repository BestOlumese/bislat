                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    <div class="col-xl-7">
                                        <form action="{{ route('product.update', ['id' => $product->id]) }}" class="needs-validation add-product-form" novalidate="" method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="form">
                                                <div class="form-group mb-3 row">
                                                    <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Title :</label>
                                                    <input class="form-control col-xl-8 col-sm-7" id="validationCustom01" name="title" value="{{ $product->title }}" type="text" required="">
                                                ...
                                                <div class="form-group mb-3 row{{ $errors->has('image1') ? ' has-error' : '' }}">
                                                    ...
                                                    <input class="form-control col-xl-8 col-sm-7" name="image1" type="file">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <input class="form-control col-xl-8 col-sm-7" name="price_discount" value="{{ $product->price_discount }}" type="number">
                                            ...
                                            <div class="form">
                                                <div class="form-group row">
                                                    ...
                                                    <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">
                                                        <div class="input-group">
                                                            <input class="touchspin" name="total_products" type="text" value="{{ $product->total_products }}">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                        <textarea id="editor1" name="details" cols="10" rows="4" required="">{{ $product->details }}</textarea>
                                                        <div class="valid-feedback">Looks good!</div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <input class="form-control col-xl-8 col-sm-7" name="label" type="text" value="{{ $product->label }}">
                                                    <div class="valid-feedback">Looks good!</div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <input class="form-control col-xl-8 col-sm-7" id="validationCustom01" name="keyword" type="text" required="" value="{{ $product->keyword }}">
                                                    <div class="valid-feedback">Looks good!</div>
